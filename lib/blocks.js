...
var addLine = function() {
    ...
    // keep raw markdown content
    this.tip._string_content += this.currentLine
};
    ...
    code_block: {
        ...
        finalize: function(parser, block) {
            if (block._isFenced) { // fenced
                ...
                // add preserved markdown tag
                block._literal = block._literal + rest + block._literal
            } else { // indented
...
var blockStarts = [
    ...
    function(parser) {
        ...
        if (!parser.indented &&
            ...
            container._string_content = parser.options.preserveRaw ?
                parser.currentLine :
                parser.currentLine.slice(parser.offset).replace(/^ *#+ *$/, '').replace(/ +#+ *$/, ''); // remove trailing ###s:
    ...
    function(parser) {
        ...
        if (!parser.indented &&
            ...
            // preserve markdown tag
            container._literal = container._fenceChar.repeat(container._fenceLength) + '\n';
